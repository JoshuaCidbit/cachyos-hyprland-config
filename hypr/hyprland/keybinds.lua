...
hl.bind(vars.kbWallpaperPicker, hl.dsp.exec_cmd(os.getenv("HOME") .. "/.config/wal/bin/wallpaper_picker.sh"))
hl.bind(vars.kbWallpaperToggle, hl.dsp.exec_cmd(os.getenv("HOME") .. "/.config/wal/bin/toggle_mpvpaper.sh"))
...
hl.bind(vars.kbGameMode, hl.dsp.exec_cmd(os.getenv("HOME") .. "/.config/hypr/scripts/gamemode.sh"))
